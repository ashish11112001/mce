...
(function($) {
    ...
    THEMEMASCOT.header = {
        ...
        TM_navLocalScorll: function() {
            var data_offset = -60;
            var $local_scroll = $("#menuzord .menuzord-menu, #menuzord-left #menuzord-right .menuzord-menu");
        ...
        TM_menuzord: function() {
            ...
            var $menuzord_left = $("#menuzord-left");
            if( $menuzord_left.length > 0 ) {
                $menuzord_left.menuzord({
                    align: "left",
                    effect: "slide",
                    animation: "none",
                    indicatorFirstLevel: "<i class='fa fa-angle-down'></i>",
