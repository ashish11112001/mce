                    ...
                    <div class="col-md-8 offset-2">
                        <div class="form-row">
                                    ...
                                    <?php
                                        if(!$files){
                                            ...
                                            foreach($fileNames as $key => $value){
                                                $del = anchor('iqac/deleteAqar/'.$eid.'/'.$key,'<i class="fa fa-times ml-2 text-danger"></i>','class=""');
                                                echo '<li>'.anchor('assets/departments/'.$short_name.'/aqardocuments/'.$value, $value, 'target="_blank"').'&nbsp;'.$del.'</li>';
                                            }
                                        }
                                    ?>
                                </ul>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <?php echo anchor('iqac/aqardocuments','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-dark btn-sm" '); ?>
                            </div>
                        </div>
                    </div>
                </div>
