            ...
            <div class="col-md-8 pull-right flip sm-pull-none">
              <div class="row list-dashed">
                <div class="col-md-12">
                        ...
                        <h4 class="title text-uppercase font-raleway font-weight-500 m-0 pb-10"><?=$alb->name;?></h4>
                          <div id="grid" class="gallery-isotope grid-3 gutter clearfix">
<?php $images= $this->admin_model->getDetailsbyfield($alb->id, 'album_id', 'album_images')->result(); ?>
                                            ...
                                            <div class="gallery-thumb">
                                                ...
                                                <div class="gallery-contect">
                                                    <ul class="styled-icons icon-bordered icon-circled icon-sm">
                                                        ...
                                                        <li><a data-rel="prettyPhoto" href="<?=base_url();?>assets/departments/<?=$short_name?>/albums/<?=$img->file_names;?>"><i
