                   ...
                   <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?=$i++;?></td>
                            <td><?=$cir->details;?></td>
                            <td><?php echo anchor('assets/departments/'.$short_name.'/seats/'.$cir->file_names,'<i class="fa fa-download"></i> Click Here','class="btn btn-warning btn-sm" target="_blank"');?></td>
                        </tr>
                   <?php } ?>
                    </tbody>
                </table>
