            ...
            <div class="row">
              <div class="col-md-12 text-center">
                ...
                <ol class="breadcrumb text-center text-black mt-10">
                  ...
                  <li class="active text-gray-silver">Time Table / Calendar Of Events </li>
                </ol>
              </div>
            </div>
          </div>
    ...
    <div class="container mt-30 mb-30 pt-30 pb-30">
        <div class="row">
            <div class="col-md-8 blog-pull-right">
                <h3 class="text-theme-colored text-uppercase mt-0"><?=$parentMenu;?>  Time Table / Calendar Of Events</h3>
                <?php
                    if($Details != null){
