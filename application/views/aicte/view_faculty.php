<main id="main-container">
    <div class="content">
        ...
        <div class="form-group row">
            <div class="col-sm-6">
                <?php echo anchor('aicte/editFaculty/'.$Faculty->id,'<i class="fas fa-edit fa-sm fa-fw"></i> Edit', 'class="btn btn-primary btn-sm" '); ?>
                <?php echo anchor('aicte/FacultyProfilePic/'.$Faculty->id,'<i class="fas fa-image fa-sm fa-fw"></i> Profile Pic', 'data-toggle="modal" data-target="#profileUpload" style="cursor: pointer;" class="btn btn-success btn-sm" '); ?>
              
                <?php echo anchor('aicte/deleteFaculty/'.$Faculty->id,'<i class="fas fa-trash fa-sm fa-fw"></i> Delete', 'class="btn btn-danger btn-sm" '); ?>

            </div>
            <div class="col-sm-6 text-right">
                <?php echo anchor('aicte/faculty','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Back to List', 'class="btn btn-dark btn-sm" '); ?>
            </div>
        </div>
    </div>
</main>
...
<div class="modal fade" id="profileUpload" tabindex="-1" role="dialog" aria-labelledby="profileUpload"
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <?=form_open_multipart('aicte/faculty_upload_pic')?>
