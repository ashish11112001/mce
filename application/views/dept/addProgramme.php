            ...
            <div class="card-body">
                    ...
                    <div class="col-md-8 offset-2">
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <?php echo form_dropdown('course_type', $courseTypes, set_value('course_type', ''),'class="form-control form-control-sm"');  ?>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="year_of_approval" id="year_of_approval"
                                    ...
                                    value="<?php echo (set_value('year_of_approval'))?set_value('year_of_approval'):'';?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="intake" id="intake" class="form-control form-control-sm"
                                    value="<?php echo (set_value('intake'))?set_value('intake'):'';?>">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="course_name" id="course_name"
                                    class="form-control form-control-sm"
                                    value="<?php echo (set_value('course_name'))?set_value('course_name'):'';?>">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="accreditations" id="accreditations" class="form-control"
                                    rows="5"><?php echo (set_value('accreditations'))?set_value('accreditations'):'';?></textarea>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="collaborations" id="collaborations" class="form-control"
                                    rows="5"><?php echo (set_value('collaborations'))?set_value('collaborations'):'';?></textarea>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="memberships" id="memberships" class="form-control"
                                    rows="5"><?php echo (set_value('memberships'))?set_value('memberships'):'';?></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php echo anchor('dept/programmes','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-dark btn-sm" '); ?>
                    </div>
                </div>
