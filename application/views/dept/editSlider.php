            ...
            <div class="card-body">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <?php
                                    if($Details->file_name){
                                            $del = anchor('dept/editSlider1/'.$Details->id,'<i class="fa fa-times ml-2 text-danger"></i>','class=""');
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php echo anchor('dept/sliders','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-dark btn-sm" '); ?>
                    </div>
                </div>
