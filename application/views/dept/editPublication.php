            ...
            <div class="card-body">
                    ...
                    <div class="col-md-8 offset-2">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <?php echo form_dropdown('publication_type', $publicationTypes, $Details->publication_type, 'class="form-control form-control-sm" id="publication_type"'); ?>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea id="details" name="details" class="form-control form-control-sm col-lg-12"
                                    rows=6><?php echo (set_value('details'))?set_value('details'):$Details->details;?>
                                </textarea>
                                <script>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="link" id="link" class="form-control form-control-sm"
                                    value="<?php echo (set_value('link'))?set_value('link'):$Details->link;?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php echo anchor('dept/publications','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-dark btn-sm" '); ?>
                    </div>
                </div>
