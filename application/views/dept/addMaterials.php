                                    ...
                                    <?php
                                        if(!$files){
                                            ...
                                            foreach($fileNames as $key => $value){
                                                $del = anchor('dept/deleteMaterials/'.$eid.'/'.$key,'<i class="fa fa-times ml-2 text-danger"></i>','class=""');
                                                echo '<li>'.anchor('assets/departments/'.$short_name.'/materials/'.$value, $value, 'target="_blank"').'&nbsp;'.$del.'</li>';
                                            }
                                        }
                                    ?>
                                </ul>
