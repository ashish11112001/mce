            ...
            <div class="card-body">
                    ...
                    <div class="col-md-8 offset-2">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="details">Achievement Details: <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <?php
                                    if($Details->file_name){
                                            $del = anchor('dept/editAchievement1/'.$Details->id,'<i class="fa fa-times ml-2 text-danger"></i>','class=""');
                                        echo '<li>'.anchor('assets/departments/'.$short_name.'/achievements/'.$Details->file_name, $Details->file_name, 'target="_blank"').'&nbsp;'.$del.'</li>';
                                    }
                                ?>
                           </div>
                           <div class="form-group col-md-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php echo anchor('dept/achievements','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-dark btn-sm" '); ?>
                    </div>
                </div>
