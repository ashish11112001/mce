                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <div class="row  pl-5">
                                    <div class="custom-control custom-checkbox mb-3 col-md-3">
                                        <input type="checkbox" class="custom-control-input" id="isHOD" name="isHOD" <?php echo ($Faculty->isHOD) ? 'checked' : null; ?>>
                                    ...
                                    <div class="custom-control custom-checkbox mb-3 col-md-4">
                                        <input type="checkbox" class="custom-control-input ml-20" id="isPrincipal"
                                            name="isPrincipal" <?php echo ($Faculty->isPrincipal) ? 'checked' : null; ?>>
                                    ...
                                    <div class="custom-control custom-checkbox mb-3 col-md-5">
                                        <input type="checkbox" class="custom-control-input" id="isVicePrincipal"
                                            name="isVicePrincipal" <?php echo ($Faculty->isVicePrincipal) ? 'checked' : null; ?>>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="priority_order" id="priority_order" min="0" class="form-control form-control-sm"
                                    value="<?php echo (set_value('priority_order'))?set_value('priority_order'):$Faculty->priority_order;?>">
