        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group row mx-3">
                    <label for="about_department" class="text-uppercase col-lg-12">About Department </label>
                ...
                <div class="form-group row mx-3">
                    <label for="vision" class="text-uppercase col-lg-12">Vision</label>
                ...
                <div class="form-group row mx-3">
                    <label for="mission" class="text-uppercase col-lg-12">Mission</label>
                ...
                <div class="form-group row mx-3">
                    <div class="col-sm-12">
                        ...
                        <?php echo anchor('dept/aboutDepartment','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-info btn-sm" '); ?>
                    </div>
                </div>
