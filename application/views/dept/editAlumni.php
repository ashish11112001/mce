                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    value="<?php echo (set_value('name'))?set_value('name'):$Alumni->name;?>">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" name="designation" id="designation"
                                    class="form-control form-control-sm"
                                    value="<?php echo (set_value('designation'))?set_value('designation'):$Alumni->designation;?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="experience" id="experience" class="form-control form-control-sm"
                                    value="<?php echo (set_value('experience'))?set_value('experience'):$Alumni->experience
                                    ;?>">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" name="email" id="email"
                                    class="form-control form-control-sm"
                                    value="<?php echo (set_value('email'))?set_value('email'):$Alumni->email;?>">
                                <?php echo form_error('email', '<div class="error">', '</div>'); ?>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="intake">Mobile:</label>
                                <input type="text" name="mobile" id="mobile" class="form-control form-control-sm"
                                    value="<?php echo (set_value('mobile'))?set_value('mobile'):$Alumni->mobile;?>">
