                    ...
                    if($PSOs){
                        ...
                        foreach ($PSOs as $PSOs1) {
                                $this->table->add_row("PSO".$i++." : ",
                                        ...
                                        anchor('dept/editPSOs/'.$PSOs1->id.'/'.$pid,'<i class="fas fa-edit"></i> Edit', 'class="btn btn-success btn-sm"').'&nbsp;'.
                                        anchor('dept/deletePSOs/'.$PSOs1->id.'/'.$pid,'<i class="fas fa-times"></i> Delete', 'class="btn btn-danger btn-sm"')
                                    );
                        }
