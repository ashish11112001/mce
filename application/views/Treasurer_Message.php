          ...
          <div class="row">
            <div class="col-md-9 pull-right flip sm-pull-none">
              <div class="row mt-10">
			    ...
			    <div class="row py-2">
						<div class="col-md-3 order-md-2 mb-4 mb-lg-0">
						    <span class="img-thumbnail d-block">
							    <img src="<?=base_url();?>assets/images/messages/treasurer.jpg" class="img-fluid" alt="treasurer">
							</span>
						</div>
			    ...
			    <div class="row">
        		    <div class="col">
        		        <p class="text-justify">I am happy to witness the continuous growth of our institution in imparting quality technical education to the students in this part of our country. It has culminated in getting autonomous status to all our UG programs since 2007. We have been identified as one of the premier institutions to implement TEQIP programs both during phase I and Phase II. Each year our students are kept abreast about the various procedural rules and regulations of the autonomous functioning of our programs through a handbook. This handbook 2019-2020, I am sure, will be a ready- reckoner in educating our students with regard to the academic regulations in detail that they are supposed to be aware of. I wish all our students a grand success in all their endeavors.</p>
                        <p class="text-justify"><strong style="   color:#c02140;">Sri S G Shridhar,</strong><br /><strong style="  color:#c02140;">Hon. Treasurer</strong> </br>Governing Council,<br />Malnad College of Engineering, <br />Hassan-573202</p>    
            </div>
        		</div>
