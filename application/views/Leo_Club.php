              ...
              <div class="row mt-10">
                <div class="col-xs-12 col-sm-12 col-md-12 mb-sm-20 p-20 pt-0 wow fadeInUp" data-wow-duration="1s"
                  ...
                  <h3 class="line-bottom mt-0"> <span class="text-theme-colored">
                     <?=$activeMenu;?></span></h3>
                      <div class="col-md-5">
                 <img src="<?=base_url().'assets/images/facilities/club/leo.jpg'?>" alt="Leo"
                        class="img-responsive img-fullwidth img-thumbnail">
                        </div>
                         <div class="col-md-7">
                 <b>About</b>
                 <p class="text-justify">LEO Club is the youth wing of Lions Club International in MCE, Hassan, conducting annual literary and cultural fests along with philanthropic activities.</p>
                 </div>
                </div>
