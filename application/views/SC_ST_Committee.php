              ...
              <div class="row mt-10">
                <div class="col-xs-12 col-sm-12 col-md-12 mb-sm-20 p-20 pt-0 wow fadeInUp" data-wow-duration="1s"
                  ...
                  <h3 class="line-bottom mt-0"> <span class="text-theme-colored">
                   ...
                   <?php echo anchor('assets/files/SC ST Committee/SCSTOBC.pdf','<i class="fa fa-download"></i> Download','class="btn btn-warning btn-sm" target="_blank"');?>
                <iframe src="<?=base_url();?>assets/files/SC ST Committee/SCSTOBC.pdf" width="100%" height="800px" style="padding:20px 0px"></iframe>
