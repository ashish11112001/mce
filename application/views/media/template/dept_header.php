                ...
                <div class="content-side">
                    <ul class="nav-main">
                        <li class="nav-main-item">
                            <?php echo anchor('media/dashboard','<i class="nav-main-link-icon si si-speedometer"></i> <span class="nav-main-link-name">Dashboard</span>','class="nav-main-link '.(($activeMenu == "dashboard")?"active":"").' "');  ?>
                        </li>
                        <li class="nav-main-item">
                            <?php echo anchor('media/displayRootContents','<i class="nav-main-link-icon si si-speedometer"></i> <span class="nav-main-link-name">File Manager</span>','class="nav-main-link '.(($activeMenu == "File Manager")?"active":"").' "');  ?>
                        </li>
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0"
                            ...
                            <div class="p-2">
                                ...
                                <?php echo anchor('media/logout','<span class="font-size-sm font-w500">Log Out</span>','class="dropdown-item d-flex align-items-center justify-content-between"');?>
                            </div>
                        </div>
                    </div>
                    <!-- END User Dropdown -->
