                  ...
                  <div class="event-details p-15 mt-20">
                    ...
                    if ($unserializedData !== false && is_array($unserializedData)) {
                        ...
                        foreach ($unserializedData as $value) {
                          echo anchor('assets/departments/AICTE/latest_news/' . $value, '<i class="fa fa-download"></i> Download', 'class="btn btn-flat btn-dark btn-theme-colored btn-sm" target="_blank"'). "\n";;
                        }
                    } 
