                  ...
                  <h3 class="line-bottom mt-0"> <span class="text-theme-colored">
                    ...
                    <?php $i=1;?>
                        ...
                        <tr>
                            <td><?=$i++;?></td>
                            <td><?= $docs->details;?></td>
                            <td> <?php echo anchor('assets/departments/IQAC/aqarreports/'.$docs->file_names,'<i class="fa fa-download"></i> View Here','class="btn btn-warning btn-sm" target="_blank"');?></td>
                        </tr>
                        <?php }?>
                         </tbody>
                    </table>
