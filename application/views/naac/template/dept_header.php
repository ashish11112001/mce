                ...
                <div class="content-side">
                    <ul class="nav-main">
                        <li class="nav-main-item">
                            <?php echo anchor('naac/dashboard','<i class="nav-main-link-icon si si-speedometer"></i> <span class="nav-main-link-name">Dashboard</span>','class="nav-main-link '.(($activeMenu == "dashboard")?"active":"").' "');  ?>
                        </li>
                    
                        <li class="nav-main-item">
                            <?php echo anchor('naac/naacs','<i class="nav-main-link-icon si si-list"></i> <span class="nav-main-link-name">NAAC Files</span>','class="nav-main-link '.(($activeMenu == "naacs")?"active":"").' "');  ?>
                        </li>
                        <li class="nav-main-item">
                            <?php echo anchor('naac/changePassword','<i class="nav-main-link-icon si si-lock"></i> <span class="nav-main-link-name">Change Password</span>','class="nav-main-link '.(($activeMenu == "changePassword")?"active":"").' "');?>
                        </li>
                        <li class="nav-main-item">
                            <?php echo anchor('naac/logout','<i class="nav-main-link-icon si si-logout"></i> <span class="nav-main-link-name">Logout</span>','class="nav-main-link"');?>
                        </li>
                    </ul>
                </div>
                <!-- END Side Navigation -->
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0"
                            ...
                            <div class="p-2">
                                <?php echo anchor('naac/changePassword','<span class="font-size-sm font-w500">Change Password</span>','class="dropdown-item d-flex align-items-center justify-content-between"');?>
                                <?php echo anchor('naac/logout','<span class="font-size-sm font-w500">Log Out</span>','class="dropdown-item d-flex align-items-center justify-content-between"');?>
                            </div>
                        </div>
                    </div>
                    <!-- END User Dropdown -->
