            ...
            <div class="card-body">
                    ...
                    <div class="col-md-8 offset-2">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="details">Naac Name: <span class="text-danger">*</span></label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php echo anchor('naac/naacs','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-dark btn-sm" '); ?>
                    </div>
                </div>
