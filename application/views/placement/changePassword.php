                ...
                <div class="row">
                    <div class="col-lg-8 offset-2">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-right" for="department_name">Department
                                Name</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control form-control-sm" id="department_name" name="department_name"
                                    placeholder="Department Name" value="<?=$department_name;?>" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-right" for="short_name">Short Name</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control form-control-sm" id="short_name" name="short_name"
                                    placeholder="Short Name" value="<?=$short_name;?>" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-right" for="username">Username</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <?php echo anchor('dept/dashboard','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-info btn-sm" '); ?>
                            </div>
                        </div>
                        </form>
                    </div>
