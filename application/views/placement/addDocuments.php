                    ...
                    <div class="col-md-8 offset-2">
                        <div class="form-row">
                                    ...
                                    <?php
                                        if(!$files){
                                            ...
                                            foreach($fileNames as $key => $value){
                                                $del = anchor('placement/deleteAccreditedDocuments/'.$eid.'/'.$key,'<i class="fa fa-times ml-2 text-danger"></i>','class=""');
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <?php echo anchor('placement/documents','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-dark btn-sm" '); ?>
                            </div>
                        </div>
                    </div>
                </div>
