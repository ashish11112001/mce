<main id="main-container">
    <div class="content">
        ...
        <div class="card shadow mb-4">
            ...
            <?php
                $url = glob('./assets/departments/'.$short_name.'/faculty/profile_'.$id.'-*.jpg');
        ...
        <div class="form-group row">
            <div class="col-sm-6">
                <?php echo anchor('faculty/profile_edit/','<i class="fas fa-edit fa-sm fa-fw"></i> Edit', 'class="btn btn-primary btn-sm" '); ?>
                <?php echo anchor('faculty/FacultyProfilePic/','<i class="fas fa-image fa-sm fa-fw"></i> Profile Pic', 'data-toggle="modal" data-target="#profileUpload" style="cursor: pointer;" class="btn btn-success btn-sm" '); ?>
                <?php echo anchor('faculty/updateProfile/','<i class="fas fa-file"></i> Update Profile', 'class="btn btn-warning btn-sm" '); ?>
               

            </div>
            <div class="col-sm-6 text-right">
                <?php echo anchor('faculty/dashboard','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Back', 'class="btn btn-dark btn-sm" '); ?>
            </div>
        </div>
    </div>
</main>
...
<div class="modal fade" id="profileUpload" tabindex="-1" role="dialog" aria-labelledby="profileUpload"
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <?=form_open_multipart('faculty/faculty_upload_pic')?>
