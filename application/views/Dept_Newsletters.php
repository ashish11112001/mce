            ...
            <div class="row">
              <div class="col-md-12 text-center">
                ...
                <ol class="breadcrumb text-center text-black mt-10">
                  ...
                  <li class="active text-gray-silver">Newsletters</li>
                </ol>
              </div>
            </div>
          </div>
    ...
    <div class="container mt-30 mb-30 pt-30 pb-30">
        <div class="row">
            <div class="col-md-8 blog-pull-right">
                <h3 class="text-theme-colored text-uppercase mt-0"><?=$parentMenu;?>  Newsletters</h3>
                <?php
                    if($Details != null){
                        ...
                        foreach ($Details as $Details1) {
                            if($Details1->file_type == "F"){
                                ...
                                $btn = anchor('assets/departments/'.$short_name.'/newsletters/'.$files,'<i class="fa fa-fw fa-download"></i> Download','class="btn btn-danger btn-xs" target="_blank"');
                            }
