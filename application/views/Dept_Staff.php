            ...
            <div class="row">
              <div class="col-md-12 text-center">
                ...
                <ol class="breadcrumb text-center text-black mt-10">
                  ...
                  <li class="active text-gray-silver">Staff</li>
                </ol>
              </div>
            </div>
          </div>
    ...
    <div class="container mt-30 mb-30 pt-30 pb-30">
        <div class="row">
            <div class="col-md-9 blog-pull-right">
                <h3 class="text-theme-colored mt-0"><?=$parentMenu;?> Staff</h3>
                <div class="section-content">
                    <div class="row multi-row-clearfix">
                        <div class="col-sm-12 col-md-12 text-left sm-text-center">
                            ...
                            foreach($staff as $staff1){
                               ...
                               $url = glob('./assets/departments/'.$short_name.'/staff/profile_'.$staff1->id.'-*.jpg');
					           if($url){
                            ...
                            <div class="upcoming-events media maxwidth400 bg-light mb-20">
                                <div class="row equal-height">
                                    ...
                                    <div class="col-sm-10 border-right pl-0 pl-sm-15">
                                        <div class="event-details staff-details p-15 mt-10">
                                            <h4 class="name"><?=$staff1->name;?></h4>
                                            <h5 class="occupation"><?=$staff1->designation;?></h5>
                                            <h5 class="additional">
                                                <?php 
                                                   echo ($staff1->mobile) ? '<span class="pr-20"><i class="fa fa-phone"></i> '.$staff1->mobile.'</span>' : null;
                                                   echo ($staff1->email) ? '<span><i class="fa fa-envelope-o"></i> '.$staff1->email.'</span>' : null;
                                                ?>
                                            </h5>
                                        </div>
                                    </div>
