<main id="main-container">
    <div class="content">
        ...
        <div class="card shadow mb-4">
            ...
            <?php
                $url = glob('./assets/departments/'.$short_name.'/student/profile_'.$Staff->id.'-*.jpg');
                if($url){
                ...
                // if($Staff->photo){
				// 	$profile_pic = base_url().'assets/departments/'.$short_name.'/student/'.$Staff->photo;
				//   }else{
				// 	$profile_pic = base_url().'assets/departments/avatar.jpg';
				//   }
            ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Department</th>
                                        <td><?php echo ($Staff->department)?$Staff->department.' ':"--"; ?></td>
                                    </tr>
        ...
        <div class="form-group row">
            <div class="col-sm-6">
                <?php echo anchor('meriise/editStudent/'.$Staff->id,'<i class="fas fa-edit fa-sm fa-fw"></i> Edit', 'class="btn btn-primary btn-sm" '); ?>
                <?php echo anchor('meriise/studentProfilePic/'.$Staff->id,'<i class="fas fa-image fa-sm fa-fw"></i> Profile Pic', 'data-toggle="modal" data-target="#profileUpload" style="cursor: pointer;" class="btn btn-success btn-sm" '); ?>
                <?php echo anchor('meriise/deleteStudent/'.$Staff->id,'<i class="fas fa-trash fa-sm fa-fw"></i> Delete', 'class="btn btn-danger btn-sm" '); ?>

            </div>
            <div class="col-sm-6 text-right">
                <?php echo anchor('meriise/student','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Back to List', 'class="btn btn-dark btn-sm" '); ?>
            </div>
        </div>
    </div>
</main>
...
<div class="modal fade" id="profileUpload" tabindex="-1" role="dialog" aria-labelledby="profileUpload"
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <?=form_open_multipart('meriise/upload_pic')?>
