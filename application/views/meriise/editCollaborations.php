            ...
            <div class="card-body">
                    ...
                    <div class="col-md-8 offset-2">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-8">
                                <label for="activity_type">Collaborations Title: <span class="text-danger">*</span></label>
                                <input type="text" name="activity_type" id="activity_type" class="form-control form-control-sm"
                                    value="<?php echo (set_value('activity_type'))?set_value('activity_type'):$Details->activity_type;?>">
                             
                                <?php echo form_error('activity_type', '<div class="error">', '</div>'); ?>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="details">Collaborations Details: <span class="text-danger">*</span></label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php echo anchor('meriise/collaborations','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-dark btn-sm" '); ?>
                    </div>
                </div>
