                        ...
                        <div class="block block-rounded block-themed mb-0">
                            <div class="block-header bg-primary-dark">
                                ...
                                <div class="block-options">
                                    <a class="btn-block-option fs-sm" href="<?= $action1;?>">Forgot Password?</a>
                                  
                                </div>
                            </div>
                            <div class="block-content">
                                <div class="p-sm-3 px-lg-4 py-lg-2 text-center">
                                    <img src="<?php echo base_url(); ?>admin_assets/media/drait.png" alt="Malnad College of Engineering" class="w-100">
                                    <h1 class="h4 mb-1">MERIISE Panel</h1>
                                    ...
                                    <div class="py-3">
                                        <div class="form-group">
                                            <input class="form-control form-control-alt form-control-lg" type="text" placeholder="Username" name="username" autocomplete="off">
                                        </div>
                                        <div class="form-group">
